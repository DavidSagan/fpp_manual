...
\end{example}
The complex Taylor is made of two Taylor series which represent the real and imaginary parts. Its direct use is also discouraged as was already explained in \sec{sec:real8}.
...
%-------------------------------
\subsubsection{The x(6) component of \vn{probe_8}  }\label{sec:codetypex6}
...
The polymorphic  quaternion \vn{quaternion_8}, not surprisingly, is given by:
 ...
 \subsection{The type {\vn{c_taylor}}  and the Taylor maps  {\vn{c_damap}}   for analysis}\label{sec:taymap}
